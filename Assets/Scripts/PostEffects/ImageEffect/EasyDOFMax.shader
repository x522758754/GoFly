// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'
 ...
 Shader "Hidden/Dof/EasyDOFMax" {
	...
	//uniform sampler2D_float  _DepthBuffer;
	//uniform half4 _DepthBuffer_ST;
	...
	{	
		...
		float4 centerTap = tex2D(_MainTex, UnityStereoScreenSpaceUVAdjust(i.uv1.xy, _MainTex_ST));
		//return float4(centerTap.a, centerTap.a, centerTap.a, 1);
